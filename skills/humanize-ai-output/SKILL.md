...
4. Diagnose the AI-ish patterns.
   - For Chinese, read `references/chinese-style-patterns.md` when the draft has strong contrast phrases like `不是...而是...` or `并非...而是...`, slogan-like wording, or stiff transitions.
...
5. Rewrite in passes:
   ...
   - Replace forced contrast patterns such as `不是...而是...`, `并非...而是...`, `是...而不是...`, `not only...but also`, and over-balanced pairings unless they clarify a real distinction.
...
6. Run the Penalty gate before showing the answer.
   ...
   - Count every forbidden structure before deciding: forced Chinese contrast, `并非...而是...`, `问题不在...而在...`, negative-first advice, broad English `not...but...`, trailing `, not...`, `not...alone`, colon-led explanations, quoted framing labels, and `X + Y + Z` shorthand.
...
- Forced contrast: `不是 A, 而是 B`, `并非 A, 而是 B`, `是 A, 而不是 B`, `not merely X but Y`.
