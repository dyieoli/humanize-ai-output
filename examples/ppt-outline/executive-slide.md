# Executive Slide Example

## Before

背景：行业快速发展；挑战：竞争日益激烈；策略：持续创新；展望：未来空间广阔。
...
- Topic labels became a claim.
- Generic strategy language became a decision implication.
- The slide now has hierarchy and a clear executive use case.
